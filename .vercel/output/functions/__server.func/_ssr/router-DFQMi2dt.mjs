...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Turn a still into a MiniMax shot prompt."
			},
			{
				name: "theme-color",
				content: "#0c0c0b"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { className: "!bg-elevated !text-fg !border-0 !shadow-[0_0_0_1px_rgba(236,234,228,0.08)] !font-[inherit]" }
				}),
